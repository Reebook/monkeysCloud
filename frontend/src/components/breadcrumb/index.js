...
function Breadcrumb(props) {
  ...
  return (
    <div className='d-flex flex-column user-select-none'>
      <div
        className='d-flex align-items-center pointer breadcrumb-button bread-container'
        onClick={handleClick}
      ...
      {isVisible && (
        <div
          className='d-flex monkeys-mt-5 position-absolute flex-wrap'
          ref={breadcrumbRef}
        >
          {/* ORGANIZATIONS */}
          <div className='monkeys-card monkeys-bg-white' style={{ zIndex: 2 }}>
